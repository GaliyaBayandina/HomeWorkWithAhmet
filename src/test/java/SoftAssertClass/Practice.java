...
//        SoftAssert softAssert = new SoftAssert();
        softAssert.assertEquals(alert.getText().trim(), "I am an alert boxx!");
        alert.accept();
        ...
        softAssert.assertEquals(alert.getText().trim(), "Press a buttondgfdg!");
        ...
        alert.accept();
        Assert.assertEquals(BrowserUtils.getText(message), "You entered text Homework is important in propmt popup");
